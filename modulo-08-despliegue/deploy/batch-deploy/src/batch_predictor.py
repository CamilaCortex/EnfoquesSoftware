...
def process_batch_file(input_file):
    ...
    # 6. Guardar predicciones en archivo de salida (parquet)
    logging.info("Paso 6: Guardando predicciones en data/output")
    output_df = df.copy()
    ...
    output_path = settings.DATA_OUTPUT_DIR / f"predictions_{batch_id}.parquet"
